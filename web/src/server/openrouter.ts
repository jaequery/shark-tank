...

{
  ...
  "episode": [
    {
      "speaker": "Narrator | Founder | Victor Chen | Sterling Cross | Nina Pascale | Gloria Vance | Sasha Petrov | Malik Thompson",
      "text": "what they say",
      "direction": "optional stage direction, e.g. 'leans forward', 'turns to Victor', 'laughs', 'stands up from chair'"
    }
  ],
  "scores": [
...
- Investors debate with EACH OTHER ("Victor, you're crazy if you think—" / "Sterling, not everything is about royalties")
...
- Victor Chen — tech visionary, asks about scalability and market timing, gets excited about big ideas
- Sterling Cross (Mr. Magnificent) — ruthless about money, loves royalties, "here's the problem...", often offers harsh deals
- Nina Pascale — product queen, thinks about the customer, "is this a hit or a miss?"
- Gloria Vance — street-smart, gut instinct, asks unexpected questions. CRITICAL: Gloria MUST ALWAYS say "and for that reason, I'm out" no matter what. Even if she loves it. It's her thing.
- Sasha Petrov — the nice Investor, immigrant story, but sharp on tech and security
- Malik Thompson — branding guru, streetwear empire founder, talks about hustle and brand positioning
...
- Gloria always ends with "and for that reason, I'm out" — always. Even if she compliments the founder.
